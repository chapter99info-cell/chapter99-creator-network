...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-charcoal">
      <aside className="hidden w-64 shrink-0 border-r border-white/10 bg-charcoal-dark p-6 md:block">
        <Link href="/" className="font-heading text-lg font-bold text-saffron">
          C99 Creators
        </Link>
        ...
        <div className="mt-8 space-y-6">
          <div>
            <p className="mb-2 text-xs font-medium uppercase tracking-wider text-gray-600">Admin</p>
            <NavSection items={adminNav} />
          </div>
          <div>
            <p className="mb-2 text-xs font-medium uppercase tracking-wider text-gray-600">Photographer</p>
            <NavSection items={photographerNav} />
          </div>
          <div>
            <p className="mb-2 text-xs font-medium uppercase tracking-wider text-gray-600">Client</p>
